 ...
 * limitations under the License.
 */
class Gs{constructor(e,t=null,n=[],r=[],i=null,s="F",o=null,a=null){this.path=e,this.collectionGroup=t,this.explicitOrderBy=n,this.filters=r,this.limit=i,this.limitType=s,this.startAt=o,this.endAt=a,this.O=null,this.k=null,this.startAt,this.endAt}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ga{get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){ba(e.idToken,"internal-error"),ba(void 0!==e.idToken,"internal-error"),ba(void 0!==e.refreshToken,"internal-error");const t="expiresIn"in e&&void 0!==e.expiresIn?Number(e.expiresIn):function(e){const t=qa(e);return ba(t,"internal-error"),ba(void 0!==t.exp,"internal-error"),ba(void 0!==t.iat,"internal-error"),Number(t.exp)-Number(t.iat)}(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}async getToken(e,t=!1){return ba(!this.accessToken||this.refreshToken,e,"user-token-expired"),t||!this.accessToken||this.isExpired?this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null:this.accessToken}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:n,refreshToken:r,expiresIn:i}=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jc extends Wc{_addListener(e,t){}_removeListener(e,t){}constructor(){super((()=>window.sessionStorage),"SESSION")}}Jc.type="SESSION";const Yc=Jc;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const Gu=Sr("authIdTokenMaxAge")||300;let Ju=null;var Yu;Yu="Browser",_i(new Vr("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),r=e.getProvider("heartbeat"),{apiKey:i,authDomain:s}=n.options;return((e,n)=>{ba(i&&!i.includes(":"),"invalid-api-key",{appName:e.name}),ba(!(null==s?void 0:s.includes(":")),"argument-error",{appName:e.name});const r={apiKey:i,authDomain:s,clientPlatform:Yu,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:dc(Yu)},o=new pc(e,n,r);return function(e,t){const n=(null==t?void 0:t.persistence)||[],r=(Array.isArray(n)?n:[n]).map(Ta);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(r,null==t?void 0:t.popupRedirectResolver)}(o,t),o})(n,r)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),_i(new Vr("auth-internal",(e=>{const t=mc(e.getProvider("auth").getImmediate());return new Ku(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),Oi("@firebase/auth","0.20.11",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(Yu)),Oi("@firebase/auth","0.20.11","esm2017");const Xu=document.querySelector(".gallery__list"),Zu=document.querySelector("[data-signUp-modal]"),Qu=document.querySelector("[data-signUp-modal-open]"),el=document.querySelector("[data-signUp-modal-close]");function tl(){Zu.classList.add("visually-hidden"),bl.textContent=""}Qu.addEventListener("click",(function(){Zu.classList.remove("visually-hidden"),sl()})),el.addEventListener("click",tl);const nl=document.querySelector("[data-signIn-modal]"),rl=document.querySelector("[data-signIn-modal-open]"),il=document.querySelector("[data-signIn-modal-close]");function sl(){nl.classList.add("visually-hidden"),_l.textContent=""}rl.addEventListener("click",(function(){nl.classList.remove("visually-hidden"),tl()})),il.addEventListener("click",sl);const ol=document.querySelector(".nav-list-logged-out"),al=document.querySelector(".nav-list-logged-in"),cl=Si({apiKey:"AIzaSyBcfxQYKzPS-PPfylqlwMHtDaShDcUDiEg",authDomain:"testmoviebase.firebaseapp.com",projectId:"testmoviebase",storageBucket:"testmoviebase.appspot.com",messagingSenderId:"1008932581270",appId:"1:1008932581270:web:6d27972f39650ac22cf7b7"}),ul=function(e,t){const n="string"==typeof e?e:t||"(default)",r=Ei("object"==typeof e?e:ki(),"firestore/lite").getImmediate({identifier:n});if(!r._initialized){const e=Tr("firestore");e&&function(e,t,n,r={}){var i;const s=(e=ds(e,Oo))._getSettings();if("firestore.googleapis.com"!==s.host&&s.host!==t&&$i("Host has been set in both settings() and useEmulator(), emulator host will be used"),e._setSettings(Object.assign(Object.assign({},s),{host:`${t}:${n}`,ssl:!1})),r.mockUserToken){let t,n;if("string"==typeof r.mockUserToken)t=r.mockUserToken,n=Mi.MOCK_USER;else{t=Or(r.mockUserToken,null===(i=e._app)||void 0===i?void 0:i.options.projectId);const s=r.mockUserToken.sub||r.mockUserToken.user_id;if(!s)throw new Ki("invalid-argument","mockUserToken must contain 'sub' or 'user_id' field!");n=new Mi(s)}e._authCredentials=new Yi(new Gi(t,n))}}(r,...e)}return r}(cl),ll=function(e=ki()){const t=Ei(e,"auth");if(t.isInitialized())return t.getImmediate();const n=function(e,t){const n=Ei(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(Nr(n.getOptions(),null!=t?t:{}))return e;ga(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:Wu,persistence:[cu,Gc,Yc]}),r=Sr("authTokenSyncURL");if(r){const e=(i=r,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>Gu)return;const r=null==t?void 0:t.token;Ju!==r&&(Ju=r,await fetch(i,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))});!function(e,t,n){Fr(e).beforeAuthStateChanged(t,n)}(n,e,(()=>e(n.currentUser))),function(e,t,n,r){Fr(e).onIdTokenChanged(t,n,r)}(n,(t=>e(t)))}var i;const s=Ir("auth");return s&&vc(n,`http://${s}`),n}(cl),hl=document.querySelector("#signUp"),dl=document.querySelector("#signIn"),fl=document.querySelector("#signOut"),pl=document.querySelector("#displayName"),ml=document.querySelector("#email"),gl=document.querySelector("#password"),vl=document.querySelector(".curr"),yl=document.querySelector("#sign-in-email"),wl=document.querySelector("#sign-in-password"),bl=document.querySelector(".sign-up-warning"),_l=document.querySelector(".sign-in-warning");let El,Il,Tl;hl.addEventListener("click",(function(){Hc(ll,ml.value,gl.value).then((e=>{e.user;console.log(vl),async function(){const e=Po(ul,"Watched",El.email);await ca(e,{}).then((()=>{console.log("Successful operation!")})).catch((e=>{alert("Unsuccessful operation, error:"+e)}))}(),async function(){const e=Po(ul,"Queue",El.email);await ca(e,{}).then((()=>{console.log("Successful operation!")})).catch((e=>{alert("Unsuccessful operation, error:"+e)}))}(),zc(ll.currentUser,{displayName:pl.value}),vl.textContent=`Welcome, ${pl.value}!`})).catch((e=>{const t=e.code,n=e.message;console.log(t),console.log(n),"auth/weak-password"===e.code?bl.textContent="Password should be at least 6 characters!":"auth/email-already-in-use"===e.code?bl.textContent="This email is already in use! Choose another one or Log In with this email!":"auth/invalid-email"===e.code&&(bl.textContent="Please, use correct and existing email!")}))})),dl.addEventListener("click",(function(){(e=ll,t=yl.value,n=wl.value,qc(Fr(e),Ac.credential(t,n))).then((e=>{console.log(e);e.user;console.log(e.user.email)})).catch((e=>{const t=e.code,n=e.message;console.log(t),console.log(n),"auth/too-many-requests"===e.code?_l.textContent="Access to this account has been temporarily disabled due to many failed login attempts!":"auth/wrong-password"===e.code?_l.textContent="Your password is invalid!":"auth/user-not-found"===e.code?_l.textContent="No user with such email!":"auth/invalid-email"===e.code&&(_l.textContent="You should write Your email in the email field!")}));var e,t,n;
/**
 * @license
 * Copyright 2020 Google LLC
 *
