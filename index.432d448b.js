 ...
 * limitations under the License.
 */
const yu=er("authIdTokenMaxAge")||300;let wu=null;var bu;bu="Browser",Yr(new gr("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),r=e.getProvider("heartbeat"),{apiKey:i,authDomain:s}=n.options;return((e,n)=>{Ho(i&&!i.includes(":"),"invalid-api-key",{appName:e.name}),Ho(!(null==s?void 0:s.includes(":")),"argument-error",{appName:e.name});const r={apiKey:i,authDomain:s,clientPlatform:bu,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Da(bu)},o=new ja(e,n,r);return function(e,t){const n=(null==t?void 0:t.persistence)||[],r=(Array.isArray(n)?n:[n]).map(Go);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(r,null==t?void 0:t.popupRedirectResolver)}(o,t),o})(n,r)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),Yr(new gr("auth-internal",(e=>{const t=Ba(e.getProvider("auth").getImmediate());return new vu(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),ni("@firebase/auth","0.20.11",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(bu)),ni("@firebase/auth","0.20.11","esm2017");const _u=document.querySelector("[data-signUp-modal]"),Eu=document.querySelector("[data-signUp-modal-open]"),Iu=document.querySelector("[data-signUp-modal-close]");function Tu(){_u.classList.add("visually-hidden"),$u.textContent=""}Eu.addEventListener("click",(function(){_u.classList.remove("visually-hidden"),Au()})),Iu.addEventListener("click",Tu);const Su=document.querySelector("[data-signIn-modal]"),ku=document.querySelector("[data-signIn-modal-open]"),Ou=document.querySelector("[data-signIn-modal-close]");function Au(){Su.classList.add("visually-hidden"),Hu.textContent=""}ku.addEventListener("click",(function(){Su.classList.remove("visually-hidden"),Tu()})),Ou.addEventListener("click",Au);const Ru=document.querySelector(".nav-list-logged-out"),Cu=document.querySelector(".nav-list-logged-in"),Pu=ei({apiKey:"AIzaSyBcfxQYKzPS-PPfylqlwMHtDaShDcUDiEg",authDomain:"testmoviebase.firebaseapp.com",projectId:"testmoviebase",storageBucket:"testmoviebase.appspot.com",messagingSenderId:"1008932581270",appId:"1:1008932581270:web:6d27972f39650ac22cf7b7"}),Nu=function(e,t){const n="string"==typeof e?e:t||"(default)",r=Xr("object"==typeof e?e:ti(),"firestore/lite").getImmediate({identifier:n});if(!r._initialized){const e=Qn("firestore");e&&function(e,t,n,r={}){var i;const s=(e=Vi(e,to))._getSettings();if("firestore.googleapis.com"!==s.host&&s.host!==t&&vi("Host has been set in both settings() and useEmulator(), emulator host will be used"),e._setSettings(Object.assign(Object.assign({},s),{host:`${t}:${n}`,ssl:!1})),r.mockUserToken){let t,n;if("string"==typeof r.mockUserToken)t=r.mockUserToken,n=di.MOCK_USER;else{t=nr(r.mockUserToken,null===(i=e._app)||void 0===i?void 0:i.options.projectId);const s=r.mockUserToken.sub||r.mockUserToken.user_id;if(!s)throw new Ei("invalid-argument","mockUserToken must contain 'sub' or 'user_id' field!");n=new di(s)}e._authCredentials=new Si(new Ii(t,n))}}(r,...e)}return r}(Pu),Lu=function(e=ti()){const t=Xr(e,"auth");if(t.isInitialized())return t.getImmediate();const n=function(e,t){const n=Xr(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(ar(n.getOptions(),null!=t?t:{}))return e;Fo(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:gu,persistence:[Nc,yc,bc]}),r=er("authTokenSyncURL");if(r){const e=(i=r,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>yu)return;const r=null==t?void 0:t.token;wu!==r&&(wu=r,await fetch(i,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))});!function(e,t,n){mr(e).beforeAuthStateChanged(t,n)}(n,e,(()=>e(n.currentUser))),function(e,t,n,r){mr(e).onIdTokenChanged(t,n,r)}(n,(t=>e(t)))}var i;const s=Zn("auth");return s&&Va(n,`http://${s}`),n}(Pu),xu=document.querySelector("#signUp"),Uu=document.querySelector("#signIn"),Du=document.querySelector("#signOut"),Mu=document.querySelector("#displayName"),ju=document.querySelector("#email"),Bu=document.querySelector("#password"),Fu=document.querySelector(".curr"),Vu=document.querySelector("#sign-in-email"),qu=document.querySelector("#sign-in-password"),$u=document.querySelector(".sign-up-warning"),Hu=document.querySelector(".sign-in-warning");let zu;xu.addEventListener("click",(function(){pc(Lu,ju.value,Bu.value).then((e=>{e.user;console.log(Fu),async function(){const e=so(Nu,"Watched",zu.email);await Lo(e,{}).then((()=>{console.log("Successful operation!")})).catch((e=>{alert("Unsuccessful operation, error:"+e)}))}(),async function(){const e=so(Nu,"Queue",zu.email);await Lo(e,{}).then((()=>{console.log("Successful operation!")})).catch((e=>{alert("Unsuccessful operation, error:"+e)}))}(),mc(Lu.currentUser,{displayName:Mu.value}),Fu.textContent=`Welcome, ${Mu.value}!`})).catch((e=>{const t=e.code,n=e.message;console.log(t),console.log(n),"auth/weak-password"===e.code?$u.textContent="Password should be at least 6 characters!":"auth/email-already-in-use"===e.code?$u.textContent="This email is already in use! Choose another one or Log In with this email!":"auth/invalid-email"===e.code&&($u.textContent="Please, use correct and existing email!")}))})),Uu.addEventListener("click",(function(){(e=Lu,t=Vu.value,n=qu.value,fc(mr(e),Za.credential(t,n))).then((e=>{console.log(e);e.user;console.log(e.user.email)})).catch((e=>{const t=e.code,n=e.message;console.log(t),console.log(n),"auth/too-many-requests"===e.code?Hu.textContent="Access to this account has been temporarily disabled due to many failed login attempts!":"auth/wrong-password"===e.code?Hu.textContent="Your password is invalid!":"auth/user-not-found"===e.code?Hu.textContent="No user with such email!":"auth/invalid-email"===e.code&&(Hu.textContent="You should write Your email in the email field!")}));var e,t,n;
/**
 * @license
 * Copyright 2020 Google LLC
 *
